 ...
 *
 * Changed by: Chris Bucchere 21-July-1997
 *
 */
...
public class BounceItem extends Applet implements Runnable {
	...
	for (int i = 1 ; i <= 8 ; i++) {
	    bounceimages[i-1] = getImage(getDocumentBase(), "images/T" + i + ".gif");
	...
	sounds[0] = getAudioClip(getDocumentBase(), "audio/ooh.au");
	sounds[1] = getAudioClip(getDocumentBase(), "audio/ah.au");
	sounds[2] = getAudioClip(getDocumentBase(), "audio/dah.au");
	sounds[3] = getAudioClip(getDocumentBase(), "audio/gong.au");
  ...
  public String getAppletInfo() {
    return "Title: Bouncing Heads Author: Jon?";
  } 
}
