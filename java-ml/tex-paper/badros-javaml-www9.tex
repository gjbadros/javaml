...
\begin{figure*}[p]
\begin{centering}
\includegraphics[height=3.25in]{treeview1.eps}
\hspace*{.5cm}
\includegraphics[height=3.25in]{treeview2.eps}
\caption{Tree views of the JavaML representation 
of the \smtexttt{FirstApplet} example as displayed by the 
XML Notepad utility~\cite{XMLNotepad}.  The left
screenshot has all nodes but the \smtexttt{block} element expanded,
and the right screenshot has earlier nodes collapsed to make room
for the full expansion of that element.
\label{fig-treeview}}
\end{centering}
\end{figure*}
}
...
\caption{Tree views of the JavaML representation 
of the \smtexttt{FirstApplet} example as displayed by XML Spy~\cite{XMLSpy}.
\label{fig-treeview}}
\end{centering}
\end{figure*}
