...
representation.  This format would be difficult to work with because of
these problems.
...
variable values and variables used as lvalues using \smtexttt{var-ref}
elements for the former, and \smtexttt{var-set} for the latter.
